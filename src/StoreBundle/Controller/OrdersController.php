...
class OrdersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('StoreBundle:Orders')->findAll();
     ...
     * @Method("POST")
     * @Template("StoreBundle:Orders:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StoreBundle:Orders')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("StoreBundle:Orders:edit.html.twig")
     */
