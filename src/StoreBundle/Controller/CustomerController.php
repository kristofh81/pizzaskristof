...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('StoreBundle:Customer')->findAll();
     ...
     * @Method("POST")
     * @Template("StoreBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StoreBundle:Customer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("StoreBundle:Customer:edit.html.twig")
     */
